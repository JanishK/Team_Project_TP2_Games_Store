...
try {
    $st = $db->prepare("
        SELECT transaction_id, order_id, payment_method, amount, transaction_status, created_at
        FROM transactions
        WHERE user_id = ?
...
$allowedTabs = ['profile', 'security', 'orders', 'transactions', 'notifications'];
    ...
    <div class="settings-grid">
        ...
        <div class="settings-main">
            ...
            <div class="settings-card">
                <h2>Profile</h2>
                <p class="helper">Update your display name and email address.</p>
                ...
                <form class="settings-form" method="post">
                    ...
                    <div class="settings-row">
                        ...
                        <input type="text" value="<?= htmlspecialchars($userDetails['username'] ?? $username) ?>" disabled style="opacity:.6;cursor:not-allowed;">
                    </div>

                    <div class="settings-row">
                        <label for="email">Email</label>
                        <input type="email" id="email" name="email" placeholder="New email address" value="<?= htmlspecialchars($userDetails['email'] ?? '') ?>">
                    </div>
                        ...
                        <table class="orders-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space:normal;max-width:240px;word-break:break-word;">
